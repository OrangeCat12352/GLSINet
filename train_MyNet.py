...
from eval_utils.main import train_val
from eval_utils.pred_generate import pred_generate
...
if __name__ == '__main__':
    ...
    for epoch in range(1, opt.epoch + 1):
        ...
        if epoch % opt.val_interval == 0:
            pred_generate(epoch)
            Sm_info, mae_info, maxEm_info, fbw_info = train_val()
            ...
            writer.add_scalar("val_maxFm", fbw_info, epoch)
