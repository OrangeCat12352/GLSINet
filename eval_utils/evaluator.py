...
class Eval_thread():
    ...
    def run(self):
        ...
        self.LOG(
            '{} dataset with {} method get {:.4f} S-measure_alpha05, {:.4f} mae  {:.4f} max-Emeasure, {:.4f} Fbw-measure.\n'
            .format(self.dataset, self.method, s_alpha05, mae, max_e, fbw))
        ...
        return ('{}  [cost:{:.4f}s]{} dataset with {} method get {:.4f} S-measure_alpha05, {:.4f} mae ，{:.4f} '
                'max-Emeasure,{:.4f} Fbw-measure.') \
            .format(datetime.now(), time.time() - start_time, self.dataset, self.method, s_alpha05, mae, max_e,
                    fbw), s_alpha05, mae, max_e, fbw
